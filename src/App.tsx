...
import facultyGnaneshwaraImg from "../assets/faculty-gnaneshwara.jpg";
                ...
                {ABOUT_CONTENT.committee.students.map((student, sIdx) => (
                  <div key={sIdx} className="bg-white border border-slate-200 rounded-2xl p-5 hover:border-[#00629B]/30 hover:shadow-md transition flex flex-col justify-between text-center items-center">
                    <div className="space-y-3 w-full">
                      ...
                      <div className="w-32 h-32 rounded-full bg-slate-200 flex items-center justify-center border border-slate-300 mx-auto text-slate-400 overflow-hidden shrink-0 shadow-inner">
                        {('image' in student && student.image) ? (
                          <img 
                            src={student.image} 
                            alt={student.name} 
                            className={`w-full h-full object-cover ${
                              student.name === "Choul Srinath" ? "object-top" : ""
                            }`}
                          />
                        ) : (
                          <svg className="w-20 h-20 mt-3" fill="currentColor" viewBox="0 0 24 24">
